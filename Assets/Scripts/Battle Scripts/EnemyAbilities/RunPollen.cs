...
public class RunPollen : MonoBehaviour
{
    ...
    public void SetTargetWithCallback(GameObject target, float pollenDuration, Action<bool> callback)
    {
        Target = target;
        duration = pollenDuration;
