...
public class AgileBotAI : BattleAI
{


    private ActionAndTarget ChooseProjectileOrAgileStar(List<GameObject> characters)
    {
    ...
    public override ActionAndTarget ChooseActionAndTarget(List<GameObject> characters, List<GameObject> enemies)
    {
        ...
        if (enemies.Count == 4)
        {
            ...
            {
                actionAndTarget = ChooseProjectileOrAgileStar(characters);
            }
        }
